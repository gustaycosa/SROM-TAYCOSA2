...
<?php echo Cabecera('Reporte de edos. relacion analisis de acreedores diversos'); ?>
<?php
    $TituloPantalla = 'Reporte de edos. relacion analisis de acreedores diversos';    
?>

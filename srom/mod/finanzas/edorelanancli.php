...
<?php echo Cabecera('Reporte de edos. relacion anticipos de clientes'); ?>
<?php
    $TituloPantalla = 'Reporte de edos. relacion anticipos de clientes';    
?>

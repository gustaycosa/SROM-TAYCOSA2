...
echo "<table id='gridacr' class='gridpop table table-striped table-bordered table-condensed table-hover display compact'></table>"; 
...
/*
 ...
 $(document).ready(function() {
         var table = $('#gridacr').DataTable({
            ...
            columnDefs: [
                { 'title': 'NOMBRE ACREEDOR', className: "text-left", 'targets': 0},
                { 'title': 'SALDO ACREEDOR', className: "text-left", 'targets': 1}
            ],
            dom: 'lfBrtip',    
            searching: true,
            ordering: false,

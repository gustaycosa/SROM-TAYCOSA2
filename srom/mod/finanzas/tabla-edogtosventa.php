 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'COSTOS', className: "text-right", 'targets': 7},
                { 'title': 'UTIL/PER GEN', className: "text-right", 'targets': 8},
                { 'title': 'AÑO ACTUAL', className: "text-right", 'targets': 9},
                { 'title': 'AÑO ANT', className: "text-right", 'targets': 10}
            ],
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_once.column( 10 ).footer() ).html('$'+ total_once.toFixed(2) );
            //===========================================================================

...
<?php echo Cabecera('Reporte de edos. relacion analisis de proveedores'); ?>
<?php
    $TituloPantalla = 'Reporte de edos. relacion analisis de proveedores';    
?>

...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'TIPO', 'width':'150px', className: "text-left", 'targets': 0},
                { 'title': 'SUCURSAL', 'width':'50px', className: "text-left", 'targets': 1},
                { 'title': 'FECHA', 'width':'50px', className: "text-left", 'targets': 2},
                { 'title': 'CONCEPTO', 'width':'150px',  className: "text-left", 'targets': 3},
                { 'title': 'DEBE', 'width':'50px', className: "text-right", 'targets': 4},
                { 'title': 'HABER', 'width':'50px', className: "text-right", 'targets': 5},
                { 'title': 'TOTAL', 'width':'50px', className: "text-right", 'targets': 6}
            ],
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_abono.column( 5 ).footer() ).html('$'+ total_abono.toFixed(2) );
            $( api_vtas.column( 4 ).footer() ).html('$'+ total_vtas.toFixed(2) );

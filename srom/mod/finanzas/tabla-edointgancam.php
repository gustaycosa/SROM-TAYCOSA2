...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'ID CONCEPTO', className: "text-left", 'targets': 0},
                { 'title': 'TIPO', className: "text-left", 'targets': 1},
                { 'title': 'SUCURSAL', className: "text-left", 'targets': 2},
                { 'title': 'FECHA', className: "text-left", 'targets': 3},
                { 'title': 'CONCEPTO', className: "text-left", 'targets': 4},
                { 'title': 'DEBE', className: "text-left", 'targets': 5},
                { 'title': 'HABER', className: "text-left", 'targets': 6},
                { 'title': 'TOTAL', className: "text-left", 'targets': 7}
            ],

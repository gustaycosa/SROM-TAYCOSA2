 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'DEBE', className: "text-left", 'targets': 1},
                { 'title': 'HABER', className: "text-left", 'targets': 2},
                { 'title': 'INGRESOS', className: "text-left", 'targets': 3},
                { 'title': 'DEVOLUCION', className: "text-left", 'targets': 4},
                { 'title': 'REFACTURACION', className: "text-left", 'targets': 5},
                { 'title': 'DESC VTAS', className: "text-left", 'targets': 6},
                { 'title': 'NETO', className: "text-left", 'targets': 7}
            ],

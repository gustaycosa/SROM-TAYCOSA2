...
//echo $xml;
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact nowrap' cellspacing='0' width='100%'><tfoot></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot></table></div>"; 
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'ARTICULO', 'width': '70px', className: "text-left", 'targets': 2},
                { 'title': 'DESCRIPCION', 'width': '70px', className: "text-left", 'targets': 3},
                { 'title': 'FACTURA ACTUAL','width': '70px', className: "text-left", 'targets': 4},
                { 'title': 'CLIENTE', 'width': '70px', className: "text-left", 'targets': 5},
                { 'title': 'SUBTOTAL', 'width': '70px', className: "text-left", 'targets': 6}
            ],
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_total.column( 6 ).footer() ).html('$'+ total_total.toFixed(2) );

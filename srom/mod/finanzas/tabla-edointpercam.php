...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->edoperdidacambiaria($parametros);
        $xml = $result->edoperdidacambiariaResult->any;
...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'TIPO', className: "text-left", 'targets': 0},
                { 'title': 'SUCURSAL', className: "text-left", 'targets': 1},
                { 'title': 'FECHA', className: "text-left", 'targets': 2},
                { 'title': 'CONCEPTO', className: "text-left", 'targets': 3},
                { 'title': 'DEBE', className: "text-left", 'targets': 4},
                { 'title': 'HABER', className: "text-left", 'targets': 5},
                { 'title': 'TOTAL', className: "text-left", 'targets': 6}
            ],

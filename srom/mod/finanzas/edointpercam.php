...
<?php echo Cabecera('Reporte de edos. Integracion de perdida cambiaria'); ?>
<?php
    $TituloPantalla = 'Reporte de edos. Integracion de perdida cambiaria';    
?>

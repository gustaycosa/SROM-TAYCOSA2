...
<?php echo Cabecera('Reporte de edos. Relacion analisis de deudores diversos'); ?>
<?php
    $TituloPantalla = 'Reporte de edos. Relacion analisis de deudores diversos';    
?>

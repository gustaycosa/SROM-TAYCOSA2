...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->ComisionesVendedorSum();
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'Refacciones', className: "text-left", 'targets': 1},
                { 'title': 'Maquinaria', className: "text-left", 'targets': 2},
                { 'title': 'Venta contado', className: "text-left", 'targets': 3},
                { 'title': 'Mano de obra', className: "text-left", 'targets': 4},
                { 'title': 'Mano de obra pintura', className: "text-left", 'targets': 5},
                { 'title': 'Traslado', className: "text-left", 'targets': 6}
            ],

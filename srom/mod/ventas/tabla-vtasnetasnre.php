...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->VtasNetasNRE($parametros);
        $xml = $result->VtasNetasNREResult->any;
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='gridfact' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' width='100%' ><tfoot><tr><th>Fecha</th><th>Sucursal</th><th>Garantia</th><th>Cliente</th><th>Nombre</th><th>Concepto</th><th>Fecha</th><th>Factura</th><th>Total Garantia</th><th>Total Factura</th><th>Garantia Aplicada</th></tr></tfoot></table></div>";
 ...
 $(document).ready(function() {
         var table = $('#gridfact').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'Grantia', className: "text-left", 'targets': 2},
                ...
                { 'title': 'Total_Garantia', className: "text-left", 'targets': 8},
                { 'title': 'Total_Fact', className: "text-left", 'targets': 9},
                { 'title': 'Garantia Aplicada', className: "text-left", 'targets': 10}
            ],
            dom: 'lfBrtip',    
            paging: false,
            searching: true,

...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->VtasNetasAbo($parametros);
        $xml = $result->VtasNetasAboResult->any;
 ...
 $(document).ready(function() {
         var table = $('#gridfact').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'Abono', className: "text-left", 'targets': 2},
                { 'title': 'Id cliente', className: "text-left", 'targets': 3},
                { 'title': 'Nombre', className: "text-left", 'targets': 4},
                { 'title': 'Concepto', className: "text-left", 'targets': 5},
                { 'title': 'Fecha', className: "text-left", 'targets': 6},
                { 'title': 'Factura', className: "text-left", 'targets': 7},
                { 'title': 'Total abono', className: "text-left", 'targets': 8},
                { 'title': 'Total factura', className: "text-left", 'targets': 9},
                { 'title': 'Abono aplicado', className: "text-left", 'targets': 10}
            ],
            dom: 'lfBrtip',    
            paging: false,
            searching: true,

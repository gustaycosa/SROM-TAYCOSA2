...
try{ 
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='gridfact' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' width='100%' ><tfoot><tr><th>Fecha</th><th>Sucursal</th><th>Refactura</th><th>Cliente</th><th>Nombre</th><th>Concepto</th><th>Fecha </th><th>Factura</th><th>Total Refactura</th><th>Total Factura</th></tr></tfoot></table></div>";
 ...
 $(document).ready(function() {
         var table = $('#gridfact').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'Total Refactura', className: "text-right", 'targets': 8},
                { 'title': 'Total Factura', className: "text-right", 'targets': 9},
            ],
            dom: 'lfBrtip',    
            paging: false,
            searching: true,
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_abono.column( 8 ).footer() ).html('$'+ total_abono.toFixed(2) );

...
$Columnas = array("FECHA","movimiento","NOMBRE","CONCEPTO","TOTAL","TotalMOFactura");//COLUMNAS GRID
...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->SP_ServicioPreventivos($parametros);
        $xml = $result->SP_ServicioPreventivosResult->any;

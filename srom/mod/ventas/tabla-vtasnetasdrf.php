...
try{ 
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='gridfact' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' width='100%' ><tfoot><tr><th>Fecha</th><th>Sucursal</th><th>Devolucion</th><th>Cliente</th><th>Concepto</th><th>Fecha</th><th>Factura</th><th>Total Devolucion</th><th>Total Factura</th><th>Devolucion Aplicada</th>/tr></tfoot></table></div>";
 ...
 $(document).ready(function() {
         var table = $('#gridfact').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'Total_Devo', className: "text-left", 'targets': 8},
                { 'title': 'Total_Fact', className: "text-left", 'targets': 9},
                { 'title': 'DevolAplicada', className: "text-left", 'targets': 10}
            ],
            dom: 'lfBrtip',    
            paging: false,
            searching: true,

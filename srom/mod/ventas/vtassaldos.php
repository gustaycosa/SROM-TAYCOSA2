...
<?php echo Cabecera('Saldos clientes por vendedor'); ?>
<?php
    $TituloPantalla = 'Saldos clientes por vendedor';  
            ...
            <div class="panel-body">
                 <form id="formulario" method="POST" class="form-inline">
                    ...
                    <div class="form-group">
                        <label for="inputtext3" class="control-label">Sucursal:</label>

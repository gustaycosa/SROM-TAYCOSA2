 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'DESCRIPCION', className: "text-left", 'targets': 1},
                { 'title': 'MODULO',className: "text-left", 'targets': 2},
                { 'title': 'ESTATUS',className: "text-left", 'targets': 3},
                { 'title': 'TIPO',className: "text-left", 'targets': 4},
                { 'title': 'GRUPO',className: "text-left", 'targets': 5},
                { 'title': 'FECHA', className: "text-left", 'targets': 6}
            ],
            'createdRow': function ( row, data, index ) {
                $(row).attr({ id:data.id_forma});
                //$(row).addClass('mec');
            },
            dom: 'lfBrtip',    
            paging: false,

...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'Id_Maquinaria', className: "text-left", 'targets': 0},
                { 'title': 'Marca', className: "text-left", 'targets': 1},
                { 'title': 'Tipo', className: "text-left", 'targets': 2},
                { 'title': 'Modelo', className: "text-left", 'targets': 3},
                { 'title': 'Horas MO', className: "text-left", 'targets': 4},
                { 'title': 'Horas MO Bitacora', className: "text-left", 'targets': 5},
                { 'title': 'Costo MO', className: "text-left", 'targets': 6},
                { 'title': 'Costo compra', className: "text-left", 'targets': 7},
                { 'title': 'Acondicionamiento', className: "text-left", 'targets': 8},
                { 'title': 'Imagen', className: "text-left", 'targets': 9}
            ],
